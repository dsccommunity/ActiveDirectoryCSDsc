...
# If running the tests on AppVeyor, an account will automatically
# be added with these credentials by the AppVeyor.yml script.
$script:adminUsername   = 'AdcsAdmin'
$script:adminPassword   = 'P4ssword1!'
